...
- Name: type0/notification-lookup.spec.ts >> Type 0 – mf-notifications: notificaties opzoeken (GET /api/notifications) >> happy path: notificaties gevonden na betaling
- Location: tests/type0/notification-lookup.spec.ts:20:7
...
Locator: getByTestId('notification-item').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByTestId('notification-item').first()
      ...
      - generic [ref=e27]:
        - generic [ref=e30]:
          ...
          - textbox "Order ID" [ref=e34]:
            ...
            - text: order-mf-notif-1778319618011
