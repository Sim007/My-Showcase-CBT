...
- Name: type0/order-lookup.spec.ts >> Type 0 – mf-order: order opzoeken (GET /api/orders/{id}) >> niet-bestaand order toont niet gevonden
- Location: tests/type0/order-lookup.spec.ts:29:7
...
Locator: getByTestId('order-not-found')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByTestId('order-not-found')
